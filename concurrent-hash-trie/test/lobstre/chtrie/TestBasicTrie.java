...
public class TestBasicTrie {
    public static void main (String[] args) {
        assertEquals (0L, BasicTrie.flagPos (0, 0, 0L, 6).flag);
        assertEquals (0, BasicTrie.flagPos (0, 0, 0L, 6).position);
        
        assertEquals (1L, BasicTrie.flagPos (1, 0, 0L, 6).flag);
        assertEquals (0, BasicTrie.flagPos (1, 0, 0L, 6).position);
        
        assertEquals (0L, BasicTrie.flagPos (0, 0, 1L, 6).flag);
        assertEquals (0, BasicTrie.flagPos (0, 0, 1L, 6).position);
        
        assertEquals (1L, BasicTrie.flagPos (1, 0, 1L, 6).flag);
        assertEquals (0, BasicTrie.flagPos (1, 0, 1L, 6).position);
        
        assertEquals (2L, BasicTrie.flagPos (2, 0, 1L, 6).flag);
        assertEquals (1, BasicTrie.flagPos (2, 0, 1L, 6).position);
        
        assertEquals (5L, BasicTrie.flagPos (5, 0, 0L, 6).flag);
        assertEquals (0, BasicTrie.flagPos (5, 0, 0L, 6).position);
        
        assertEquals (5L, BasicTrie.flagPos (5, 0, 2L, 6).flag);
        assertEquals (1, BasicTrie.flagPos (5, 0, 2L, 6).position);
        
        assertEquals (5L, BasicTrie.flagPos (5, 0, 2L, 6).flag);
        assertEquals (1, BasicTrie.flagPos (5, 0, 2L, 6).position);
        
        assertEquals (2L, BasicTrie.flagPos (2, 0, 2L, 6).flag);
        assertEquals (0, BasicTrie.flagPos (2, 0, 2L, 6).position);
        ...
        assertEquals (63, BasicTrie.flagPos (-1, 6, Long.MIN_VALUE, 6).flag);
        assertEquals (4, BasicTrie.flagPos (-1, 6, 15, 6).position);
    }
